package com.pact.product.consumer;
...
import com.pact.product.core.Item;
import com.pact.product.core.ProductService;
...
public class RetailerContractTests {
  ...
  @Pact(consumer = "pactProduct", provider = "pactRetailer")
